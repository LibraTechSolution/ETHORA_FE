...
const AddFundsModal = ({ isOpen, onDismiss }: { isOpen: boolean; onDismiss: () => void }) => {
    ...
    <>
      ...
      <Modal isOpen={isOpen} onClose={onDismiss}>
        ...
        <ModalContent
          ...
          fontSize={'14px'}
        >
          <ModalHeader>Buy ELP (addFunds)</ModalHeader>
          <ModalCloseButton />
          <ModalBody>
            <form>
          ...
          <ModalFooter>
            <Button colorScheme="primary" mr={3} onClick={() => {console.log('Approve')}} width={'100%'}>
              Approve
            </Button>
